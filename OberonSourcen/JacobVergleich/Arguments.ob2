...
MODULE Arguments;
   ...
   TYPE ArgTable* =
      POINTER TO ARRAY 1000 OF
      POINTER TO ARRAY 1000 OF CHAR;

   PROCEDURE GetArgs* (VAR argc:LONGINT; VAR argv: ArgTable); END GetArgs;
   ...
   PROCEDURE GetEnv* (VAR env: ArgTable); END GetEnv;
