...
MODULE InOut;
  ...
  PROCEDURE WriteCard* (x, n: LONGINT);
  ...
  PROCEDURE WriteOct* (x, n: LONGINT);
  ...
  PROCEDURE WriteHex* (x, n: LONGINT);
  ...
  PROCEDURE WriteReal* (x: REAL; n: LONGINT; k: LONGINT);
  ...
  PROCEDURE WriteLongReal* (x: LONGREAL; n: LONGINT; k: LONGINT);
